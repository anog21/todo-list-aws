...
def get_translated(key, language, dynamodb=None):
    table = get_table(dynamodb)
    ...
    try:
        ...
        translated = translate.translate_text(Text=result['Item']["text"], SourceLanguageCode="auto", TargetLanguageCode=language)
